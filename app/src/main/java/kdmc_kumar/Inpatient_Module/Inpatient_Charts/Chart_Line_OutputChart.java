...
public class Chart_Line_OutputChart extends AppCompatActivity {
    ...
    private void GetInitialize() {
        ...
        Close.setOnClickListener(view -> Chart_Line_OutputChart.this.finish());
...
//**********************************************************************************************
    ...
    private ArrayList<LineDataSet> getDataSet(String Id) {
        ...
        SQLiteDatabase db = BaseConfig.GetDb();//Chart_Line_OutputChart.this);
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                do {
                    ...
                    v3 = new BarEntry((float) Integer.parseInt(c.getString(c.getColumnIndex("op_motion"))), c.getPosition()); // Jan
                    valueSet3.add(v3);
        ...
        LineDataSet lineDataSet11 = new LineDataSet(valueSet1, "OP_RVIES");
...
*/
        LineDataSet lineDataSet21 = new LineDataSet(valueSet2, "OP_MOTION");
...
*/
        LineDataSet lineDataSet31 = new LineDataSet(valueSet3, "OP_URINE");
